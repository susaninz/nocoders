...
Как строить Telegram ботов, которые не стыдно показать. Архитектура, UI паттерны, работа с состоянием — всё из опыта реальных проектов.

**Для кого:**

- Вайбкодеры, которые делают ботов
- Те, кто хочет структурировать бота
- Начинающие, которым нужен рабочий пример
