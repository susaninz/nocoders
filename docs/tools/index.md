...
Рабочие инструменты вайбкодера: Git, Docker, терминал. Команды, алиасы, best practices — то, что реально используется каждый день.

**Для кого:**

- Вайбкодеры, которые хотят ускорить workflow
- Те, кто настраивает новую машину
- Начинающие, которым нужен базовый набор
