...
1. Найди агента в списке **Recent** в sidebar
...
!!! tip "Зачем переименовывать"
    Когда работаешь с несколькими агентами, имена типа "Agent 1", "Agent 2" путают.
    Называй по роли: "Напарник", "Ревизор", "Летописец" — сразу видно кто есть кто.
...
```bash
cp ~/Cursor/nocoders/docs/cursor/agency/staff/напарник.md ~/Cursor/my-project/prompts/
```
